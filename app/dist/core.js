...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.navigation = (0, _jquery2.default)(".primary-nav a");
        ...
        value: function createPageSectionWaypoint() {
            ...
            this.pageSection.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            var smoothlink = currentPageSection.getAttribute("data-matching");
                            nav.navigation.removeClass("current-link");
                            (0, _jquery2.default)(smoothlink).addClass("current-link");
                        }
                    },
                    offset: "18%"
                });
